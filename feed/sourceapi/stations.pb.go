...
type GetUpcomingTrainsResponse_UpcomingTrain struct {
	...
	ProjectedArrival *timestamp.Timestamp `protobuf:"bytes,3,opt,name=projected_arrival,json=projectedArrival,proto3" json:"projected_arrival,omitempty"`
...
func (x *GetUpcomingTrainsResponse_UpcomingTrain) GetProjectedArrival() *timestamp.Timestamp {
	if x != nil {
...
func (x *GetUpcomingTrainsResponse_UpcomingTrain) GetLastUpdated() *timestamp.Timestamp {
	if x != nil {
...
// UnimplementedStationsServer can be embedded to have forward compatible implementations.
...
func RegisterStationsServer(s *grpc.Server, srv StationsServer) {
	s.RegisterService(&_Stations_serviceDesc, srv)
}
...
var _Stations_serviceDesc = grpc.ServiceDesc{
